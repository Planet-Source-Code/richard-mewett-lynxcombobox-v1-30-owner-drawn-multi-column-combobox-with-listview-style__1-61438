...
Public Property Get ItemText(ByVal Index As Long, ByVal Item As Long) As String
    If UBound(mItems(mRowPtr(Index)).sValue) >= Item Then
        ItemText = mItems(mRowPtr(Index)).sValue(Item)
    End If
End Property

Public Property Let ItemText(ByVal Index As Long, ByVal Item As Long, NewValue As String)
    If UBound(mItems(mRowPtr(Index)).sValue) >= Item Then
        mItems(mRowPtr(Index)).sValue(Item) = NewValue
    End If
End Property
...
Private Function SearchCode(sCode As String, nMode As lcSearchEnum) As Long
    Dim lCount As Long
